...
const plans = [
  {
    ...
    features: [
      ...
      { text: "Controle de tanque fazenda", included: true },
      { text: "Alertas de manutenção", included: true },
      { text: "Modo offline", included: true },
      { text: "Dashboard com gráficos", included: false },
      { text: "Gestão de pneus", included: false },
      { text: "Checklists de máquinas", included: false },
    ],
    popular: false,
    cta: "Começar Grátis",
  },
  {
    ...
    features: [
      ...
      { text: "Gestão de pneus", included: true },
      { text: "Checklists de máquinas", included: true },
      { text: "Exportação Excel/PDF", included: true },
      { text: "Relatórios avançados", included: true },
      { text: "Suporte por email", included: true },
      { text: "Gestão de operadores", included: false },
      { text: "GPS e Rastreamento", included: false },
    ],
    popular: false,
    cta: "Assinar Agora",
  },
  {
    ...
    features: [
      ...
      { text: "GPS em tempo real (1 incluso)", included: true },
      { text: "Geocercas e alertas", included: true },
      { text: "Push Notifications iOS/Android", included: true },
      { text: "Alertas WhatsApp e Email", included: true },
      { text: "Detecção de anomalias (IA)", included: true },
      { text: "Gestão de operadores e CNH", included: true },
      { text: "Ordens de serviço", included: true },
      { text: "Custo por hectare (TCO)", included: true },
      { text: "Múltiplas propriedades (até 5)", included: true },
      { text: "Login de funcionários", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "GPS em tempo real (3 inclusos)", included: true },
      { text: "Propriedades ilimitadas", included: true },
      { text: "Usuários ilimitados", included: true },
      { text: "Push/WhatsApp/Email ilimitados", included: true },
      { text: "Integração IoT completa", included: true },
      { text: "Gestão financeira", included: true },
      { text: "API completa", included: true },
      { text: "Relatórios customizados", included: true },
      { text: "Alertas IoT (combustível, motor)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "GPS em tempo real (2 inclusos)", included: true },
